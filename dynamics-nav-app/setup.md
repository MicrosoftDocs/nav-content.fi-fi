...
---
# <a name="setting-up-dynamics-nav"></a>Dynamics NAV -sovelluksen määrittäminen
...
Joidenkin alueiden edellytyksenä on, että käyttäjä on [!INCLUDE[d365fin](includes/d365fin_md.md)]-tilauksen järjestelmänvalvoja. Lisätietoja on kohdassa [Asetukset ja hallinto Dynamics NAV -ohjelmassa](admin-setup-and-administration.md).  

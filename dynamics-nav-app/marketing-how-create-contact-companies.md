...
Ennen uuden kontaktin luomista kannattaa ehkä tarkistaa asetukset **Kontaktienhallinnan asetukset** -ikkunasta. Lisätietoja on kohdassa [Markkinoinnin ja kontaktien hallinnan määrittäminen](marketing-setup-marketing.md).
...
1. Valitse oikeassa yläkulmassa oleva **Etsi sivua tai raporttia** -kuvake ja syötä jokin seuraavista sen mukaan, mistä haluat luoda kontakteja. Valitse sitten liittyvä linkki.
...
[Liikesuhteiden liittäminen kontaktiin](marketing-business-relations.md#assign-business-relations-to-a-contact)  
[Toimialaryhmien liittäminen kontaktiin](marketing-industry-groups.md#assign-industry-groups-to-a-contact)  
[Postitusryhmien liittäminen kontaktiin](marketing-mailing-groups.md#assign-mailing-groups-to-a-contact)  

...
Jos sinulla on sellaisia [!INCLUDE[d365fin](includes/d365fin_md.md)] -ohjelmaa koskevia kysymyksiä, joihin ei ole vastauksia tässä dokumentaatiossa, voit kysyä asiaa Dynamics NAV -yhteisöltä. Lisätietoja on kohdassa [Dynamics NAV, Business edition -yhteisö](https://community.dynamics.com/business). Lisäksi tukitiimimme julkaisee erilaisia vihjeitä. Katso lisätietoja [Dynamics NAV -tuen blogista](https://blogs.msdn.microsoft.com/dyn365finsupport).  

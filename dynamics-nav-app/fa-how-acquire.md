...
Sekä pääkäyttöomaisuuserä että kaikki sen komponentit tulee määrittää omiksi käyttöomaisuuden korteiksi. Sen jälkeen kun komponenttiluettelo on määritetty, Dynamics NAV täyttää automaattisesti käyttöomaisuuskorttien **Pääkäyttöomais.erä/komponentti**- ja **Pääkäyttöomaisuuserän kompon.** -kentät.
...
6. Valitse oikeassa yläkulmassa oleva **Etsi sivu tai raportti** -kuvake, syötä **Käyttöomaisuuden asetukset** ja valitse sitten aiheeseen liittyvä linkki.
...
**Vihje**: Jos käyttöomaisuuden KP-päiväkirjan **Vakuutusnro**-kenttä täytetään silloin, kun hankintameno kirjataan, Dynamics NAV kirjaa myös käyttöomaisuuden hankintamenon vakuutuksen kattavuuskirjauksiin. Lisätietoja on kohdassa [Toimintaohje: Käyttöomaisuuden vakuuttaminen](fa-how-insure.md).
...
1. Valitse oikeassa yläkulmassa oleva **Etsi sivu tai raportti** -kuvake, syötä **Peruuta KO-tapahtumat** ja valitse sitten aiheeseen liittyvä linkki.

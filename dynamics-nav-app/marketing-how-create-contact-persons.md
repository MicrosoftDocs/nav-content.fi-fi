...
**Huomautus**: **Kontaktienhallinnan asetukset** -ikkunan **Periytyminen**-osassa valittujen kenttien sisältö kopioidaan yrityksestä kyseisen yrityksen henkilöille.

##<a name="see-also"></a>Katso myös
[Markkinoinnin ja kontaktien hallinnan määrittäminen](marketing-setup-marketing.md)  
[Postitusryhmien määrittäminen kontakteille](marketing-mailing-groups.md#assign-mailing-groups-to-a-contact)

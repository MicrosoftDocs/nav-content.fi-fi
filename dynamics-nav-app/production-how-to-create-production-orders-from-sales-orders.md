...
---
# <a name="how-to-create-production-orders-from-sales-orders"></a>Tuotantotilausten luominen myyntitilauksista
...
Voit valita myös projektituotantotilauksen luominen. Lisätietoja on ohjeaiheessa [Projektitilausten suunnitteleminen](production-how-to-plan-project-orders.md).   

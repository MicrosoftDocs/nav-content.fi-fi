...
| --- | --- |
| Microsoft Dynamics NAV | Sisältää koontinäytön, jossa on tärkeitä aikaperusteisia taloustietoja, kuten tulojen ja menojen vertailu, käyttökate ja käyttöpääomasykli.|
| Microsoft Dynamics 365 for Sales | Sisältää koontinäytön, jossa on tärkeitä tietoja myyntimahdollisuuksista ja kontakteista.  |
| Microsoft Dynamics 365 for Sales | Sisältää koontinäytön, jossa on tärkeitä tietoja myynnistä ja varastosta. |
...
* [!INCLUDE[d365fin](includes/d365fin_md.md)]in käyttöoikeus. Lisätietoja on kohdassa [Dynamics NAV](http://go.microsoft.com/fwlink/?LinkID=759714).  

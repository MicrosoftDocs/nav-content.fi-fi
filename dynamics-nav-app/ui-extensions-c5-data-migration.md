...
# <a name="the-c5-data-migration-extension-for-dynamics-nav"></a>Dynamics NAV -ohjelman tietojen siirron C5-laajennuksen käyttäminen
...
> [!Note]
> Muista, että vain avoimet tapahtumat siirretään. Historiatietoja ei siirretä.

...
## <a name="define-a-mailing-group-code"></a>Postitusryhmän koodin määrittäminen
...
1. Valitse oikeassa yläkulmassa oleva **Etsi sivu tai raportti** -kuvake, syötä **Postitusryhmät** ja valitse sitten aiheeseen liittyvä linkki.
...
## <a name="assign-mailing-groups-to-a-contact"></a>Postitusryhmien liittäminen kontaktiin
1. Avaa kontakti.

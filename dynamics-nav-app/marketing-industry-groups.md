...
## <a name="define-an-industry-group-code"></a>Toimialaryhmän koodin määrittäminen
...
1. Valitse oikeassa yläkulmassa oleva **Etsi sivu tai raportti** -kuvake, syötä **Toimialaryhmät** ja valitse sitten aiheeseen liittyvä linkki.
...
## <a name="assign-industry-groups-to-a-contact"></a>Toimialaryhmien liittäminen kontaktiin
...
Kontaktiin liitettyjen toimialaryhmien lukumäärä näkyy **Kontakti**-ikkunan **Segmentointi**-osan **Toimialaryhmien lkm** -kentässä.
